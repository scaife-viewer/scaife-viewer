...
const fetchCollection = async (urn) => {
...
const fetchCollectionVector = async (urn, ends) => {
...
const textSearch = async ({ q, size, offset, ...scope }) => {
